  ...
  <div class="highslide-gallery">
    <div class="product-block">
      ...
      <div class="prod-description">
        <h3>Dortmund</h3>
        <p class="price"><span id="dortmund-price"></span> лей/м<sup>2</sup></p>
        <p>Тонкая, ровная и нежная плитка. Подойдёт для тех кто предпочитает простоту и лаконичность.
            Размеры 235*63*10мм
            1 м<sup>2</sup>- 68 плиток
        </p>
